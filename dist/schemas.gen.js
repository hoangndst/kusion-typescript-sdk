...
exports.v1_ModulePatcherConfigSchema = exports.v1_ModuleConfigsSchema = exports.v1_ModuleConfigSchema = exports.v1_GenericConfigSchema = exports.v1_FakeProviderDataSchema = exports.v1_FakeProviderSchema = exports.v1_ConfigsSchema = exports.v1_BackendConfigSchema = exports.v1_AzureKVProviderSchema = exports.v1_AzureEnvironmentTypeSchema = exports.v1_AlicloudProviderSchema = exports.v1_AWSProviderSchema = exports.url_UserinfoSchema = exports.url_URLSchema = exports.request_WorkspaceConfigsSchema = exports.request_UpdateWorkspaceRequestSchema = exports.request_UpdateStackRequestSchema = exports.request_UpdateSourceRequestSchema = exports.request_UpdateProjectRequestSchema = exports.request_UpdateOrganizationRequestSchema = exports.request_UpdateModuleRequestSchema = exports.request_UpdateBackendRequestSchema = exports.request_StackImportRequestSchema = exports.request_CreateWorkspaceRequestSchema = exports.request_CreateStackRequestSchema = exports.request_CreateSourceRequestSchema = exports.request_CreateProjectRequestSchema = exports.request_CreateOrganizationRequestSchema = exports.request_CreateModuleRequestSchema = exports.request_CreateBackendRequestSchema = exports.models_ChangesSchema = exports.models_ChangeStepSchema = exports.models_ActionTypeSchema = exports.kusionstack_io_kusion_pkg_apis_api_kusion_io_v1_TypeSchema = exports.entity_WorkspaceSchema = exports.entity_StackSchema = exports.entity_SourceSchema = exports.entity_RunSchema = exports.entity_ResourceRelationSchema = exports.entity_ResourceInfoSchema = exports.entity_ResourceGraphSchema = exports.entity_ResourceSchema = exports.entity_ProjectSchema = exports.entity_OrganizationSchema = exports.entity_ModuleSchema = exports.entity_BackendSchema = exports.constant_StackStateSchema = exports.constant_SourceProviderTypeSchema = exports.constant_RunTypeSchema = exports.constant_RunStatusSchema = void 0;
exports.v1_ViettelCloudProviderSchema = exports.v1_VaultProviderSchema = exports.v1_VaultKVStoreVersionSchema = exports.v1_SpecSchema = exports.v1_SecretStoreSchema = exports.v1_ResourceSchema = exports.v1_ProviderSpecSchema = exports.v1_OnPremisesProviderSchema = void 0;
exports.constant_RunStatusSchema = {
    enum: [
        "Scheduling",
        "InProgress",
        "Failed",
...
exports.constant_RunTypeSchema = {
...
exports.constant_SourceProviderTypeSchema = {
...
exports.constant_StackStateSchema = {
    enum: [
        "UnSynced",
        "Synced",
        "OutOfSync",
...
exports.entity_OrganizationSchema = {
    properties: {
        creationTimestamp: {
...
exports.entity_ResourceGraphSchema = {
    properties: {
        relations: {
            items: {
...
exports.entity_ResourceRelationSchema = {
    properties: {
        dependencyResource: {
            type: "string",
        },
...
exports.entity_WorkspaceSchema = {
    properties: {
        backend: {
            allOf: [
                {
...
exports.kusionstack_io_kusion_pkg_apis_api_kusion_io_v1_TypeSchema = {
    enum: ["Kubernetes", "Terraform"],
    type: "string",
    "x-enum-varnames": ["Kubernetes", "Terraform"],
};
exports.models_ActionTypeSchema = {
    enum: [0, 1, 2, 3, 4],
    type: "integer",
    "x-enum-comments": {
...
exports.models_ChangeStepSchema = {
    properties: {
        action: {
            allOf: [
                {
...
exports.request_CreateBackendRequestSchema = {
    properties: {
        backendConfig: {
            allOf: [
                {
...
exports.request_CreateModuleRequestSchema = {
    properties: {
        description: {
            description: "Description is a human-readable description of the module.",
            type: "string",
...
exports.request_CreateSourceRequestSchema = {
    properties: {
        description: {
            description: "Description is a human-readable description of the source.",
            type: "string",
...
exports.request_CreateStackRequestSchema = {
    properties: {
        description: {
            description: "Description is a human-readable description of the stack.",
            type: "string",
...
exports.request_CreateWorkspaceRequestSchema = {
    properties: {
        backendID: {
...
exports.request_StackImportRequestSchema = {
    properties: {
        importedResources: {
            additionalProperties: {
                type: "string",
...
exports.request_UpdateBackendRequestSchema = {
    properties: {
        backendConfig: {
            allOf: [
                {
...
exports.request_UpdateModuleRequestSchema = {
    properties: {
        description: {
            description: "Description is a human-readable description of the module.",
            type: "string",
...
exports.request_UpdateProjectRequestSchema = {
    properties: {
        description: {
            description: "Description is a human-readable description of the project.",
            type: "string",
...
exports.request_UpdateSourceRequestSchema = {
    properties: {
        description: {
            description: "Description is a human-readable description of the source.",
            type: "string",
...
exports.request_UpdateWorkspaceRequestSchema = {
    properties: {
        backendID: {
            description: "BackendID is the configuration backend id associated with the workspace.",
            type: "integer",
...
exports.request_WorkspaceConfigsSchema = {
    properties: {
        context: {
            allOf: [
                {
...
exports.url_UserinfoSchema = {
    type: "object",
};
exports.v1_AWSProviderSchema = {
    properties: {
        profile: {
...
exports.v1_AlicloudProviderSchema = {
    properties: {
        region: {
...
exports.v1_AzureEnvironmentTypeSchema = {
...
exports.v1_BackendConfigSchema = {
    properties: {
        configs: {
            additionalProperties: {},
...
exports.v1_FakeProviderDataSchema = {
    properties: {
        key: {
            type: "string",
        },
...
exports.v1_GenericConfigSchema = {
    additionalProperties: {},
    type: "object",
};
exports.v1_ModuleConfigSchema = {
    properties: {
        configs: {
            allOf: [
                {
...
exports.v1_ModuleConfigsSchema = {
    additionalProperties: {
        $ref: "#/definitions/v1.ModuleConfig",
    },
    type: "object",
};
exports.v1_ModulePatcherConfigSchema = {
    properties: {
        projectSelector: {
...
exports.v1_OnPremisesProviderSchema = {
    properties: {
        attributes: {
            additionalProperties: {
                type: "string",
...
exports.v1_VaultKVStoreVersionSchema = {
    enum: ["v1", "v2"],
    type: "string",
    "x-enum-varnames": ["VaultKVStoreV1", "VaultKVStoreV2"],
};
exports.v1_VaultProviderSchema = {
    properties: {
        path: {
...
exports.v1_ViettelCloudProviderSchema = {
    properties: {
        cmpURL: {
